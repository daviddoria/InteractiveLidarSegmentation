...
void InnerWidget::StartProgressSlot()
{
...
void InnerWidget::StopProgressSlot()
{
  // When the ProgressThread emits the StopProgressSignal, we need to display the result of the segmentation
...
float InnerWidget::ComputeLambda()
{
...
void InnerWidget::sldHistogramBins_valueChanged()
{
  this->GraphCut.SetNumberOfHistogramBins(sldHistogramBins->value());
}

void InnerWidget::radForeground_clicked()
{
  this->GraphCutStyle->SetInteractionModeToForeground();
}

void InnerWidget::radBackground_clicked()
{
  this->GraphCutStyle->SetInteractionModeToBackground();
}

void InnerWidget::btnClearSelections_clicked()
{
  this->GraphCutStyle->ClearSelections();
}

void InnerWidget::btnSaveSelections_clicked()
{
...
void InnerWidget::btnCut_clicked()
{
